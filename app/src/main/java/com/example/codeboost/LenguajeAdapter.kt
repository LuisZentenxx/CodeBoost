...
import com.example.codeboost.Language
import com.example.codeboost.R

class LanguageAdapter(private val languageList: List<Language>) : RecyclerView.Adapter<LanguageAdapter.LanguageViewHolder>() {
    ...
    inner class LanguageViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(language: Language) {
            languageIcon.setImageResource(language.iconResource)
